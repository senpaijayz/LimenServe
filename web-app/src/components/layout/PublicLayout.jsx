...
const PublicLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-primary-900 print:block print:min-h-0 print:bg-white">
                ...
                <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-3 px-4 py-2 text-xs md:px-8 xl:px-12">
                    <div className="flex min-w-0 items-center gap-4">
                        <span className="inline-flex min-w-0 items-start gap-2">
                            ...
                            <span className="min-w-0">Genuine and aftermarket parts from a real Pasay City store</span>
                        </span>
                    </div>
                    <div className="flex min-w-0 flex-wrap items-center gap-4 text-white/80">
                        <span className="inline-flex min-w-0 items-center gap-2">
                            <Phone className="h-3.5 w-3.5 shrink-0 text-red-400" />
                            <span className="min-w-0 break-words">{primaryPhone} | {landline}</span>
                        </span>
            ...
            >
                <div className="mx-auto max-w-[1600px] px-4 md:px-8 xl:px-12">
                    <div className="flex min-w-0 items-center justify-between gap-3 py-4 sm:gap-4">
                        <Link to="/" className="flex min-w-0 flex-1 items-center gap-3 xl:flex-none">
                            <img src={logoUrl} alt={`${companyName} logo`} className="h-11 w-11 shrink-0 rounded-lg border border-primary-200 bg-white p-1 shadow-sm" />
                            <div className="min-w-0">
                                <p className="truncate text-[11px] font-semibold uppercase tracking-[0.22em] text-accent-primary">{brandKicker}</p>
                                <h1 className="truncate text-base font-bold text-primary-950 sm:text-xl">{brandTitle}</h1>
                            </div>
                        </Link>
                        ...
                        <button
                            type="button"
                            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-primary-300 text-primary-700 xl:hidden"
            ...
            <main className="flex-1">
                <section className="border-b border-primary-200 bg-primary-100/90 print:hidden">
                    <div className="mx-auto flex max-w-[1600px] flex-wrap items-center gap-3 px-4 py-3 text-xs text-primary-600 md:px-8 xl:px-12">
                        <span className="inline-flex max-w-full min-w-0 items-center gap-2 rounded-full border border-primary-200 bg-white px-3 py-1.5 font-semibold text-primary-700">
                            <ShieldCheck className="h-3.5 w-3.5 shrink-0 text-accent-primary" />
                            Genuine Parts
                        </span>
                        <span className="inline-flex max-w-full min-w-0 items-center gap-2 rounded-full border border-primary-200 bg-white px-3 py-1.5 font-semibold text-primary-700">
                            <CarFront className="h-3.5 w-3.5 shrink-0 text-accent-danger" />
                            Mitsubishi Specialists
                        </span>
                        <span className="inline-flex max-w-full min-w-0 items-center gap-2 rounded-full border border-primary-200 bg-white px-3 py-1.5 font-semibold text-primary-700">
                            <Clock className="h-3.5 w-3.5 shrink-0 text-accent-primary" />
