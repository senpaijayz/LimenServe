...
router.get('/bootstrap', requireRole('admin', 'staff'), async (req, res, next) => {
  try {
...
router.get('/search', requireRole('admin', 'staff'), async (req, res, next) => {
  try {
...
router.get('/items/:productId', requireRole('admin', 'staff'), async (req, res, next) => {
  try {
