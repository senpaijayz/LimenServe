...
Production credentials are intentionally not committed to Git. Configure the
browser-safe production values in Vercel Project Settings before each production
build. Preview/Staging remains intentionally blocked until an isolated backend and
Supabase project are supplied.
